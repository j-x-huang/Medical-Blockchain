...
async function revokeMedicalRecordsSharing(revokeTransaction) {
  ...
  let results = query('selectPatientKey', { p: resource + patient.getFullyQualifiedIdentifier(), hp: resource + healthProvider.getFullyQualifiedIdentifier() });
  ...
  revokeMedicalRecordsSharingNotification.patient = revokeTransaction.patient;
  revokeMedicalRecordsSharingNotification.healthProvider= revokeTransaction.healthProvider;
